                ...
                <>
                    {
                        ...
                        <ul className={styles.adminul}>
                            <li className={styles.adminli}><Link href="/admin"><a>Add Seats</a></Link></li>
                            <li className={styles.adminli}><Link href="/admin/cinema"><a>Add Floor</a></Link></li>
                            <li className={styles.adminli}><Link href="/admin/showtime"><a>Add Time</a></Link></li>
                        </ul>
                    }
                    <ul className={styles.ul}>
                        ...
                        <li className={styles.li}><Link href="/tickets"><a>Booked</a></Link></li>
