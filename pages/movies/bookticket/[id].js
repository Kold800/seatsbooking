...
const BookTicket = (props) => {
    ...
    return (
        <div className={styles.contain}>
            ...
            <h1 className={styles.book_title}>Book Seats</h1>
            <div className={styles.add_simple}>
                <div className={styles.add_main}>
                    <label className={styles.add_label} htmlFor="cinema">Select Floor</label>
                ...
                <div className={styles.add_main}>
                    <label className={styles.add_label} htmlFor="bookingdate">Select Date</label>
                ...
                </div>
                {
                    ...
                    <div className={styles.add_main}>
                        <label className={styles.add_label} htmlFor="time">Select Time</label>
